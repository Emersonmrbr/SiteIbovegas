<meta charset="utf-8" /> <!-- Definição da linguagem do site -->
...
Todas as configurações de SEO, para melhor divulgação do site estão nas linhas a seguir.
-->
...
<title>IBOVegas</title>

<!--
============================
CHAMADA DAS FOLHAS DE ESTILO
============================

Todas as configurações de estilo do site estão nos arquivos a baixo.
-->
<link rel="stylesheet" type="text/css" href="app/assets/css/style
.css" />
<!--
============================
****************************
...
<link rel="icon" href="app/assets/img/NucleoMap.ico" type="image/x-icon" /> <!-- Imagem da aba do navegador -->
